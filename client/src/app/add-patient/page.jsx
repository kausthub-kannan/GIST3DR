            ...
            <form className="my-8" onSubmit={handleSubmit}>
              <div className="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-2 mb-4 border-2 border-[#7fee64] p-2 rounded-md card">
                ...
                <input
                  ...
                  className="bg-transparent appearance-none outline-none border-none focus:ring-0 text-base font-medium w-full"
                />
                {errors.name && <p className="text-red-500">{errors.name}</p>}
              </div>
              <div className="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-2 mb-4 border-2 border-[#7fee64] p-2 rounded-md card">
                <label htmlFor="age" className=" shrink-0">
                  Age :{" "}
                </label>
                <input
                  id="age"
              ...
              <div className="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-2 mb-4 border-2 border-[#7fee64] p-2 rounded-md card">
                <label htmlFor="dicom_file" className="">
                  DICOM File :{" "}
                </label>
                <input
                  id="dicom_file"
                ...
                />
                {errors.dicom_file && (
                  <p className="text-red-500">{errors.dicom_file}</p>
                )}
              </div>
