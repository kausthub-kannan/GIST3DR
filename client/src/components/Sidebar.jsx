          ...
          <li>
            <TooltipProvider delayDuration={0}>
              <Tooltip>
                <TooltipTrigger>
                  <Link href="/">
                    <button className="card text-white text-sm flex gap-2 p-2 rounded-full bg-[#7fee64] border-[#7fee64] text-[#1b1b1b] transition-transform duration-300 ease-in-out hover:scale-110">
                      <svg
            ...
            <BackgroundGradient className=" max-w-sm p-4">
              <div className="flex gap-2">
                <div className="w-full flex-1">
                  <h2>
                    Hello {first_name || "Doctor"} {last_name}
                  </h2>
                ...
                {loading ? (
                  ...
                  <button
                    ...
                    className="card w-14 h-14 flex justify-center items-center text-white text-sm p-2 rounded-full bg-[#7fee64] border-[#7fee64] text-[#1b1b1b] transition-transform duration-300 ease-in-out hover:scale-110"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="28"
